...
<div class="container-fluid">
    ...
    <form action="student/addstudent.php" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12">
                <div class="hod-card-form1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
                                <label for="rollno">Roll no <sup><span style="color: red;">*</span></sup></label>
                                <input type="text" name="rollno" class="form-control" id="rollno" aria-describedby="emailHelp" placeholder="Enter roll no *" required>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
                                <label for="admission">Admission date</label>
                                <input type="date" name="admission" class="form-control" id="admission" aria-describedby="emailHelp" placeholder="Enter Admission Date">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
