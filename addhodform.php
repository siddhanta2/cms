...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 pt-3">
            <h2>Dashboard <span class="float-right" style="font-size: 14px; line-height: 45px;"><a href="dashboard.php" class="mr-1">Home</a> <span><i class="fas fa-angle-right"></i><i class="fas fa-angle-right"></i></span><span class="ml-2">Add HOD Form</span></span></h2><hr>
        </div>
    </div>

    <form action="hod/addhod.php" method="POST" enctype="multipart/form-data">
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="salary" class="form-control" id="salary" aria-describedby="emailHelp" placeholder="Enter Mobile No *" required>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
                                <label for="joining">Joining Date</label>
                                <input type="date" name="joining" class="form-control" id="joining" aria-describedby="emailHelp" placeholder="Enter Your Email">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12">
                            <div class="form-group">
