...
<?php
    ...
    $sql = mysqli_query($conn, "SELECT * FROM `hod` WHERE id = '$id'") or mysqli_error($conn);
...
<div class="container-fluid">
    ...
    <form action="hod/updatehod.php" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="hod_id" value="<?php echo $id;?>">
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <img src="hod/<?php echo $row['image']; ?>" alt="" class="img-thumbnail" height="70px" width="70px">
                            </div>
                        </div>
                    </div>
