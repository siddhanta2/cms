...
<?php
    ...
    $sql = mysqli_query($conn, "SELECT * FROM `students` WHERE id = '$id'") or mysqli_error($conn);
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 pt-3">
            <h2>Dashboard <span class="float-right" style="font-size: 14px; line-height: 45px;"><a href="dashboard.php" class="mr-1">Home</a> <span><i class="fas fa-angle-right"></i><i class="fas fa-angle-right"></i></span><span class="ml-2">Add Student Form</span></span></h2><hr>
        </div>
    </div>

    <form action="student/updatestudent.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <img src="student/images/<?php echo $row['image']; ?>" alt="" class="img-thumbnail" height="70px" width="70px">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="rollno" value="<?php echo $row['roll_number']; ?>" class="form-control pt-2" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="admission" value="<?php echo $row['admission_date']; ?>" class="form-control pt-2" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                        </div>
                    </div>
